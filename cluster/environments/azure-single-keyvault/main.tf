...
module "aks-gitops" {
  source = "github.com/dzins/bedrock?ref=master//cluster/azure/aks-gitops"
...
module "keyvault_flexvolume_role" {
  source = "github.com/dzins/bedrock?ref=master//cluster/azure/keyvault_flexvol_role"
...
module "flex_volume" {
  source = "github.com/dzins/bedrock?ref=master//cluster/azure/keyvault_flexvol"
